...
export default function Home() {
    ...
    return (
        <Container fluid no-gutters>
            <div id="bio-view" className="row mt-10">
                        ...
                        <div className='mx-auto'>
                            ...
                            <section className="bio text-justify">
                                ...
                                <p className="bio-blurb mt-2 ">
                                    I'm a Full Stack Web Developer with a background in software engineering, an advanced degree in Computer Information Systems, and a certificate from the UofA's (Tucson) Full Stack Web Development program. I'm a disciplined, adaptable, and upbeat collaborator focused on deadlines, bottom lines, and clean lines of code. I have strong technical skills with JavaScript, React, Node, MongoDB, and MySql. My background includes user interface design, extensive client-facing communication, and code installation/customization. I'm a client-favorite conferece presenter, an ideation champ, and a competent producer of actionable documentation. I'm equally happy creating alone or as an Agile Development Team member. I like live music, friendly debate, and decimating hiking boots.
                            </p>
                            </section>
